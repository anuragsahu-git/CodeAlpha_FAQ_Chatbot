...
FAQ_DATABASE = [
    ...
    {"question": "How do I apply for an internship?", "answer": "To apply for an internship, visit the official internship portal, explore the available opportunities, and submit your application with the required details. Ensure that your profile, resume, and relevant skills are up to date to maximize your chances of selection. Once submitted, applicants may be contacted for further evaluation and onboarding processes.", "tags": "apply application internship registration enroll join opportunity candidate resume selection onboarding"},
    {"question": "What is the official internship portal of CodeAlpha?", "answer": "The official internship portal of CodeAlpha is https://www.codealpha.tech/.", "tags": "CodeAlpha official internship portal website application tech link"},
    {"question": "What technologies are used?", "answer": "The internship program provides exposure to a wide range of modern technologies, including Artificial Intelligence, Machine Learning, Data Science, Web Development, Python Programming, Cloud Computing, and other industry-relevant tools. The specific technologies may vary depending on the selected domain and project requirements, ensuring practical and hands-on learning experiences.", "tags": "technologies tools tech stack python artificial intelligence machine learning data science web development cloud computing programming skills"},
    ...
    {"question": "Who is eligible for the internship?", "answer": "Students, fresh graduates, and learners from any educational background who are interested in developing practical technical skills are eligible to apply.", "tags": "eligibility eligible who can apply student graduate fresher qualification criteria"},
    {"question": "Can first-year students apply?", "answer": "Yes, students from any academic year can apply if they are interested in learning and completing the internship tasks.", "tags": "first year beginner fresher eligibility student"},
    {"question": "Is the internship paid or unpaid?", "answer": "Please refer to the internship details provided for your specific batch, as compensation policies may vary depending on the program.", "tags": "paid unpaid stipend salary compensation money"},
    {"question": "Is there any registration fee?", "answer": "Please refer to the current internship announcement or contact support for information regarding any applicable registration fees.", "tags": "fee registration payment cost charges"},
    {"question": "Can international students apply?", "answer": "Yes, international applicants can participate if they meet the program requirements.", "tags": "international foreign global worldwide students"},
    {"question": "How do I join the internship WhatsApp group?", "answer": "After successful registration, instructions for joining the official WhatsApp group will be shared through the communication channels provided during onboarding.", "tags": "whatsapp group join link onboarding community"},
    {"question": "When will I receive my certificate?", "answer": "Certificates are generally issued after the internship batch ends and all submitted tasks have been reviewed successfully.", "tags": "certificate receive when issued delivery completion"},
    {"question": "I have not received my certificate. What should I do?", "answer": "If your certificate has not been received within the announced processing period, please contact support with your registered details for assistance.", "tags": "certificate missing not received delay pending support"},
    {"question": "How can I verify my certificate?", "answer": "Your certificate contains a QR code and Unique ID that can be used to verify its authenticity.", "tags": "verify certificate qr unique id validation authenticate"},
    {"question": "Can I resubmit a task after submission?", "answer": "Yes, if corrections are required and the submission window is still open, you may submit an updated version of your project.", "tags": "resubmit update modify task correction edit"},
    {"question": "What file formats are accepted for submission?", "answer": "Ensure your source code is uploaded to GitHub and provide all required links, documentation, and supporting materials as specified in the submission guidelines.", "tags": "file format upload submission github documentation requirements"},
    {"question": "My GitHub repository is private. Is that allowed?", "answer": "No. Evaluators must be able to access your project repository. Please ensure the repository visibility follows the internship guidelines.", "tags": "private github repository public access visibility permissions"},
    {"question": "Can I use AI tools like ChatGPT during the internship?", "answer": "Yes, AI tools may be used for learning, debugging, and research. However, all submitted work must be understood, customized, and completed by you.", "tags": "chatgpt ai tools copilot assistance help learning"},
    {"question": "Can I use external datasets for my project?", "answer": "Yes, publicly available datasets may be used provided they are properly referenced in your project documentation.", "tags": "dataset kaggle public data external dataset source"},
    {"question": "Can I submit projects developed using any programming language?", "answer": "Unless a specific technology is required for a task, you may use the programming language and framework best suited to your project.", "tags": "programming language python java c++ javascript framework technology"},
    {"question": "How can I track my internship progress?", "answer": "Keep track of completed tasks, GitHub uploads, LinkedIn posts, and submission confirmations to monitor your internship progress effectively.", "tags": "progress status tracking monitor completed tasks internship"},
    {"question": "How do I know if my submission was successful?", "answer": "You should receive a confirmation after submitting through the official submission process. Keep a record of your submission details for future reference.", "tags": "submission successful confirmation submitted received acknowledgment"},
    {"question": "Will I get placement assistance?", "answer": "Eligible interns may receive placement support and career guidance based on program policies and overall performance.", "tags": "placement assistance jobs career support opportunities recruitment"},
    {"question": "Can I do multiple internship domains at the same time?", "answer": "Please follow the guidelines of your enrolled program. If multiple domains are permitted, ensure you can successfully complete all required tasks and commitments.", "tags": "multiple domains tracks simultaneously parallel internship"},
    {"question": "How long is the internship duration?", "answer": "The internship duration depends on the batch and program you have enrolled in. Please refer to your onboarding details or official announcements for the exact timeline.", "tags": "duration period internship length timeline batch"},
    {"question": "What should I do if I face technical issues during submission?", "answer": "If you encounter technical issues during submission, contact support immediately and provide screenshots or error details to help resolve the issue quickly.", "tags": "technical issue submission error problem support troubleshooting"},
    {"question": "Can I update my LinkedIn post after submission?", "answer": "Yes, you may update your LinkedIn post if necessary, provided that all required internship information remains clearly visible.", "tags": "linkedin update edit modify social media post"},
    {"question": "Do I need a GitHub account for the internship?", "answer": "Yes, a GitHub account is required for hosting and sharing your project source code as part of the internship submission process.", "tags": "github account required repository source code version control"},

    # --- Account & Registration ---
    {"question": "I entered the wrong email during registration. What should I do?", "answer": "Please contact support as soon as possible with your correct details so that your registration information can be updated.", "tags": "wrong email registration update change email correction"},
    {"question": "Can I update my personal information after registration?", "answer": "Yes, contact support with the necessary details if you need to update your registered information.", "tags": "update profile edit personal information name email phone"},

    # --- Offer Letter ---
    {"question": "When will I receive my offer letter?", "answer": "Offer letters are generally shared after successful registration and onboarding. Please check the communication channels provided during registration.", "tags": "offer letter receive when internship offer"},
    {"question": "How can I verify my offer letter?", "answer": "If verification features are provided, follow the instructions mentioned on the offer letter or contact support for assistance.", "tags": "offer letter verify validation authenticity"},

    # --- Submission & Evaluation ---
    {"question": "How are projects evaluated?", "answer": "Projects are evaluated based on functionality, code quality, documentation, originality, and adherence to the task requirements.", "tags": "evaluation criteria review assessment grading"},
    {"question": "What happens after I submit my tasks?", "answer": "Your submission will be reviewed by the evaluation team. Eligible interns will receive further updates regarding certification and internship completion.", "tags": "after submission review evaluation next step"},

    # --- Certificates & LOR ---
    {"question": "Is the Letter of Recommendation guaranteed?", "answer": "No. The Letter of Recommendation is awarded based on exceptional performance and fulfillment of the specified criteria.", "tags": "lor guaranteed recommendation eligibility"},
    {"question": "Will my certificate mention my performance?", "answer": "Certificate details depend on the internship policies and certificate format used for your batch.", "tags": "certificate performance grade distinction mention"},

    # --- Projects ---
    {"question": "Can I create my own project instead of the listed tasks?", "answer": "Please follow the internship guidelines. If custom projects are permitted, they should align with the internship objectives and receive approval if required.", "tags": "custom project own project alternative task"},
    {"question": "Can I use open-source code in my project?", "answer": "Yes, provided that you comply with the license terms and clearly acknowledge the source. The majority of the project should reflect your own work.", "tags": "open source code github reuse license attribution"},

    # --- Frequently Asked Human Questions ---
    {"question": "Are there any live sessions or mentorship sessions?", "answer": "Please refer to your batch announcements and official communication channels for information regarding live sessions and mentorship activities.", "tags": "live session mentor mentorship webinar meeting"},
    {"question": "Will I receive internship support if I get stuck?", "answer": "Yes, support is available through the designated communication channels and internship community groups.", "tags": "help support stuck doubt guidance mentor"},
    {"question": "Can I leave the internship after joining?", "answer": "Participation is voluntary. However, leaving before completing the requirements may affect eligibility for internship benefits and certification.", "tags": "leave quit withdraw cancel internship"},

    # --- One Very Important Missing Intent ---
    {"question": "How do I check whether my certificate is verified?", "answer": "You can verify your certificate using the QR code or verification mechanism provided on the certificate.", "tags": "check certificate verify validation authentic genuine qr"},

    # --- Internship Status & Acceptance ---
    {"question": "How do I know if I have been selected for the internship?", "answer": "You will receive an official confirmation through the communication channels used during registration. Please monitor your email and other onboarding notifications.", "tags": "selected selection accepted acceptance application status"},
    {"question": "My application is still pending. What should I do?", "answer": "Application reviews may take time. If you have not received an update within the expected timeframe, please contact support.", "tags": "pending application review status waiting"},

    # --- WhatsApp Group Issues ---
    {"question": "I joined the internship but did not receive the WhatsApp group link.", "answer": "Please contact support with your registration details so the team can verify your enrollment and assist you.", "tags": "whatsapp group link missing not received join"},
    {"question": "I accidentally left the WhatsApp group. What should I do?", "answer": "Contact support and provide your registration details to request assistance with rejoining the group.", "tags": "left whatsapp group rejoin join again"},

    # --- GitHub & Submission ---
    {"question": "Can I submit more than the required number of tasks?", "answer": "Yes, submitting additional tasks may help showcase your skills and dedication.", "tags": "extra task additional tasks more than required"},
    {"question": "Can I change my GitHub repository after submission?", "answer": "If updates are necessary and the submission window remains open, you may provide the updated repository information according to the submission guidelines.", "tags": "change github repository update submission"},

    # --- LinkedIn ---
    {"question": "Do I need a LinkedIn account for the internship?", "answer": "A LinkedIn account is recommended because certain internship activities may require project sharing and professional networking.", "tags": "linkedin account required social media"},
    {"question": "What should I include in my LinkedIn post?", "answer": "Include a brief description of your project, relevant internship details, your GitHub repository link, and any required tags or mentions.", "tags": "linkedin post content description github project"},

    # --- Technical Support ---
    {"question": "What should I do if my GitHub link is not working?", "answer": "Verify that the repository is accessible, the URL is correct, and the repository visibility matches the submission requirements.", "tags": "github link broken invalid repository access"},
    {"question": "What should I do if my deployed project is not working?", "answer": "Check your deployment logs, verify all required dependencies, and update the deployment before final submission.", "tags": "deployment issue project not working hosted app error"},

    # --- Internship Completion ---
    {"question": "How do I know if I have successfully completed the internship?", "answer": "Successful completion depends on meeting all internship requirements, submitting the required tasks, and passing the evaluation process.", "tags": "completed internship completion status finished"},
    {"question": "What happens if I do not complete the required tasks?", "answer": "Failure to complete the minimum required tasks may affect your eligibility for certification and other internship benefits.", "tags": "incomplete tasks fail requirement certificate eligibility"},

    # --- AI Assistant-Specific Questions ---
    {"question": "Can I ask technical questions about my project?", "answer": "Yes, the assistant can help explain concepts, provide guidance, and assist with debugging-related questions.", "tags": "technical help project support debugging coding"},
    {"question": "Can you review my project idea?", "answer": "Yes, I can provide feedback on project ideas and suggest possible improvements based on the internship requirements.", "tags": "project idea review feedback suggestion"},

    # --- One Category You're Missing Entirely ---
    {"question": "Who developed this assistant?", "answer": "This assistant was developed to help CodeAlpha interns access information, understand requirements, and receive instant support.", "tags": "developer creator made this assistant built chatbot"},
    {"question": "Are you a human or an AI?", "answer": "I am an AI-powered virtual assistant designed to provide information and support related to the CodeAlpha internship program.", "tags": "human ai bot chatbot artificial intelligence"},

    # ==========================================
    # --- ORIGINAL FAQ DATABASE (PRESERVED) ---
    # ==========================================
